/**
 * @license AngularJS v1.2.19-local+sha.535479f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.19-local+sha.535479f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.19-local+sha.535479f',    // all of these placeholder strings will be replaced by grunt's
